var finances = [
  ...
  document.getElementById('Total:').textContent = netTotal;
  document.getElementById('Average Change:').textContent = averageChange;
  document.getElementById('Greatest increase in Profit/Losses:').textContent = greatestIncrease.date + '  ' + greatestIncrease.amount;
  document.getElementById('Greatest decrease in Profit/Losses:').textContent = greatestDecrease.date + ' ' + greatestDecrease.amount;
